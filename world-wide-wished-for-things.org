...
The plan can be done (what else to fight for? if not order and leisure in the world), but...(this kind of transitioning is too hard to think of, I know, but I once wrote "this was the beginning of this century [and all experience before was only some beautiful or ugly disctruction/disorder and flourishing again], but what will be the end of this century be like, 2200 AD?"; making progress with order AND research)

How to have a real world feedback loop NOT ONLY WITH ME?? Just in the internet/web. Anyone can voice issues via "issues". And, maintainers, people who try to weigh arguments to optimize the construction via world-wide-wished-things and decide what's in what's not, SHOULD BE MANY, having the principle of neutrality (reason, logic, cultural [gender] equality) in mind! (even if many more people having my SSH keys {digital cryptographic keys to manage this repository}, how else to avoid edit war? [not speaking about the identity of the philosopher of reflection, but finding consent by objectivity, neutrality in our yet so fragile "community" -- optimizing everything, a very IMPERSONAL view: and it only makes sense this way if we think about managing humanity in general?)

Github or other services are not enough -- everything should open source. Specialized domain and website is necessaray, decentralized?!

People in want of ending austerity, some political effort is necessary, but somehow it can be spread pretty easily, right?
...
but also: Rinse   and Reason  (safety and alignment of body and society, not exploiting power, but [more] cooperative reasoning, planning, see rest of this file)

- alignment: meet yourself and meet ourselves finally
  - for Rinse you need energy, e.g.: rice?!! pancakes, butter, (fruit-) sugar
...
* TODO safety first in a functional state
** safe passwords -- safer life (why to kill someone if you cannot get at his/her money)
- long, random, on usb stick! but: ppl exploited this standard practice so often, what else to do? phone with some personal id: voice, thumb (moving, alive), iris (moving, alive) (all at once, pretty well testable with phones) transfer key via bluetooth etc.?!!!!
  - sendable "heartbeat" about this authentication -> distributed database of e-government identity management of citizens
    - no one shall get lost! police work does not make sense without it. The state and its police. Eternal succumbing of children/women, sex to offer in some basement? Who knows of this practice, why to believe in something good? Sex and money... enough ppl of status in, and it is very well fixed this business.
  - banking
    - TAN generator as standard
    - phone video authentification to validate transactions (best way to validate citizens functionaliy -> "heartbeat" device)
  - ATM (Bankautomat) and PIN is lacking safety, better like above!
    - esp. this vs. standard alignment (labor/nuissance of upgrading all ATMs)
  - personal data safety:
    - merging forbidden to merge information for ordinary citizens (car licence plate -> address )
...
* WAITING sex and society
** interpersonal sex vs. selfsex, relationship problems and violence, prostitution profit
- being in want of having sex and not getting it, violations of other human bodies might ensue (häusliche Gewalt, parents split off, children violated [plus: is it a topic possibly to speak about it in society? considerations of reputation block management by society -- what cannot be spoken of, cannot be managed/remedied], "it's only about sex, aha" -- to be in WANT of it)
- selfsex as remedy, personal relaxion, relaxing interpersonal WANT of sex:
  - men: cushion-condom sex
    - dancing to DJanes
  - women: dildo-mounted at wall for doggy-style insertion or similar practice
    - dancing to DJs
- difficulties speaking about (self-)sex vs. reputation among other humans
  - Who will know about it? If you do not speak about. You can know it by this text. So many problems by being in WANT of sex and not getting it.
- SO MANY PEOPLE DO NOT KNOW HOW MUCH OF A JOY SEX IS! PROSTITUTION MIGHT PROFIT, TOO!
- PUNSENCLUBS UND LEUTE INS MESSER LAUFEN LASSEN / SLEEP AND DIE IN A BROTHEL, PROFIT, TOO!
* INFO sex work
