...
one plan finally to combat confusion, simplex first to deal with our complex society:
no socialism
free market
...
- heartbeat device :: continuous life sign of citizen, banking activity authenticated by video identification on phone
* Problem / Solution
...
- practicing symmetry (how humans can achieve bestform of animals):
  - head first symmetry via (sit) rinse alignment = "being your own doctor" (a trick for the sick -- not feeling their body) VS. perfect muscle activation, perfect smile; a privilege, can be taken away by whom? The functional state I'd say (future music)
  - bokken (wodden sword, making hands strong first, same action, both sides/hands)
  - this freedom of the body, may mean a lot to find your own way in society (esp. parents' influence...?!)
    - trust in your own body, trust in other bodies
      - women giving birth to children: how to relax while giving birth when head muscles are locked, i.e. belly hiddenly cramped, too (remedy for incisions [Kaiserschnitt?], all the blood, the wonder of life?)
